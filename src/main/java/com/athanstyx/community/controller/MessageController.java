...
import com.athanstyx.community.entity.Page;
import com.athanstyx.community.entity.User;
import com.athanstyx.community.service.MessageService;
...
//        Integer.parseInt("dasda");//测试错误
    ...
    public String getLetterDetail(@PathVariable("conversationId") String conversationId, Page page, Model model) {
        ...
        //消息列表
        List<Message> letterList = messageService.finLetters(conversationId, page.getOffset(), page.getLimit());
    ...
    @ResponseBody //因为是异步添加的, 只是局部更新,所以返回的json也就是字符串
