package com.athanstyx.community.quartz;


import com.athanstyx.community.service.DiscussPostService;
import com.athanstyx.community.service.ElasticsearchService;
...
public class PostScoreRefreshJob implements Job, CommunityConstant {
    ...
    static{
        try {
            ...
            throw new RuntimeException("初始化athanstyx纪元失败",e);
        }
    }
    ...
    private void refresh(int postId) {
        ...
        // 点赞数量
        long likeCount = likeService.finEntityLikeCount(ENTITY_TYPE_POST, postId);
